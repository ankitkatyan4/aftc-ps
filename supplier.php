...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Supplier Report</h2>
...
window.open("supplier.php?id=".concat(result),"_self");
...
$result1 = mysqli_query($con,"SELECT * FROM supplier ".$var."  Order by SiNo  ");


while($row1 = mysqli_fetch_array($result1))

{
$result = mysqli_query($con,"SELECT * FROM assets Where Supplier_Detail= ".$row1['SiNo']);
echo "<tr style=\"color:black;font-size:12px;\">";
echo " <th colspan=\"7\" > <b>Supplier Name : </b> ".$row1['Name'] ." </th>
</tr>";
