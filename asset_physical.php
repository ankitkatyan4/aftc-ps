...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Physical Location Report</h2>
...
window.open("asset_physical.php?id=".concat(result),"_self");
			...
			<div class="wrap-table100">
				<div class="table100">
					<table>
						...
						<tbody>
						<?php 
						if ( isset($_GET['id'])&& !empty($_GET['id']) ){$var = "Where Physical_Location LIKE '".$_GET['id']."'";}
						else {$var="";}
$con=mysqli_connect("localhost","root","","aftc_mess");
// Check connection
if (mysqli_connect_errno())
...
$result1 = mysqli_query($con,"SELECT DISTINCT Physical_Location FROM assets ".$var);


while($row1 = mysqli_fetch_array($result1))

{
$result = mysqli_query($con,"SELECT * FROM assets Where Physical_Location LIKE '".$row1['Physical_Location']."'");
echo "<tr style=\"color:black;font-size:12px;\">";
echo " <th colspan=\"7\" > <b>Location : </b> ".$row1['Physical_Location'] ." </th>
</tr>";
