...
<div>
		...
		<form action="all_asset_search2.php" method="get">
		<table class="gfg">
			<tr>
		<td> Search Item</td>
		<td>
...
<input type="Submit" value="Click to Apply Filter"></tr>
</table>
...
if(chks)
{window.open("add_asset_edit.php?id=".concat(chks),"_self");}
					...
					<table id="tblcheck">
						<thead>
							...
							<th class="column3"></th>
								...
								<th class="column2">Property Book</th>
...
{
echo "<tr>";
echo "<td><input type=\"radio\" name=\"check_list\" value=\"". $row['ID'] . "\" id=\"". $row['ID'] . "\"></td>";
echo "<td>" . $row['ID'] . "</td>";
echo "<td>" . $row['Item'] . "</td>";
echo "<td>" . $row['Description'] . "</td>";
echo "<td>" . $row['Manufacturer'] . "</td>";
echo "<td>" . $row['Model'] . "</td>";
echo "<td>" . $row['Property_Book'] . "</td>";
