...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Select Owner To Edit</h2>
		<div class="wrap-table100">
<form action="all_owner_search.php" method="get">
		<table>
...
$result = mysqli_query($con,"SELECT DISTINCT Unit FROM owner");
...
if(chks)
{window.open("owner_add_edit.php?id=".concat(chks),"_self");}
...
<button type="button"  onclick="myFunction()">Edit</button></div>
				<div class="table100">
					<table>
						...
						$query='';
						if ( isset($_GET['unit']) && !empty($_GET['unit']) && strcmp($_GET['unit'],"All")!=0)
						{
						$query=" Where Unit LIKE '".$_GET['unit']."'  ";
						}
$con=mysqli_connect("localhost","root","","aftc_mess");
// Check connection
if (mysqli_connect_errno())
...
$result = mysqli_query($con,"SELECT * FROM owner ".$query);
