...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Check In Asset  </h2>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<script type="text/javascript">
	...
	window.open("checkedin2.php?id=".concat(selected),"_self");
		
        }
		else
		{window.alert("Please Select items to checkout");
		
		}
    };
</script>
<button type="button"  onclick="myFunction2()">Check-In</button>&nbsp;&nbsp;&nbsp;
...
{
echo "<tr>";
echo "<td><input type=\"checkbox\" name=\"check_list[]\" value=\"". $row['serial'] . "\" id=\"". $row['serial'] . "\"></td>";
echo "<td>" . $row['ID'] . "</td>";
echo "<td>" . $row['Item'] . "</td>";
