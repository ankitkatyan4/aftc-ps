...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Owner Contact Book</h2>
...
document.getElementById("datetime").innerHTML=dt.toLocaleString();</script> 
			...
			<div><form action="owner_add.php">
    <input type="submit" value="Add Owner" />
</form>
<form action="all_owner_search.php">
    <input type="submit" value="Edit Owner" />
</form>

<form action="owner_contact.php" method="get">
		<table>
...
<input type="Submit" value="Search"></tr></form></div>
				<div class="table100">
					<table>
						<thead>
...
$query='';
						...
						if ( isset($_GET['itemid']) && !empty($_GET['itemid']) && strcmp($_GET['itemid'],"All")!=0)
						{
						$query=" Where SiNo LIKE '".$_GET['itemid']."'  ";
						}
$con=mysqli_connect("localhost","root","","aftc_mess");
// Check connection
if (mysqli_connect_errno())
