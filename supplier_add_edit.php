...
{
mysqli_query($con,"Replace INTO `supplier`(`SiNo`,`Name`, `City`, `Address`, `Phone_number`) VALUES ('".$_GET['ids']."','".$_GET['name']."','".$_GET['city']."','".$_GET['address']."','".$_GET['phno']."')");

	echo "<script>  window.open('supplier_contact.php?itemid=".$_GET['ids']."','_self'); </script>" ;
}

if (isset($_GET['id'])&& !empty($_GET['id']) and $_GET['id'])
{ $row3= mysqli_fetch_array(mysqli_query($con,"SELECT * from supplier Where SiNo = ".$_GET['id']));

echo "
<form action=\"supplier_add_edit.php\" method=\"get\">
<table width=\"200px\">
</tr>
<br>
<br>
...
<td>
<input type=\"text\" name=\"ids\" maxlength=\"50\" size=\"30\" readonly value=".$row3['SiNo'].">
</td>
</tr>
<tr>
<td>
...
<td>
<input type=\"text\" name=\"name\" maxlength=\"50\" size=\"30\" value=".$row3['Name'].">
</td>
</tr>
<tr>
<td>
...
<td>
<textarea name=\"address\" maxlength=\"1000\" cols=\"30\" rows=\"2\"  required value=".$row3['Address']."> 
</textarea>
</td>
</tr>
<tr>
...
<td>
<input type=\"text\" name=\"city\" maxlength=\"50\" size=\"30\" value=".$row3['City'].">
</td>
</tr>
<tr>
<td>
...
<td>
<input type=\"number\" name=\"phno\" maxlength=\"50\" size=\"30\">\
</td>
</tr>
<tr>
