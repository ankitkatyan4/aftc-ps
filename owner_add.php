...
mysqli_query($con,"INSERT INTO `owner`(`Name`, `Unit`, `Address`, `Phone_number`) VALUES ('".$_GET['name']."','".$_GET['unit']."','".$_GET['address']."','".$_GET['phno']."')");
	
	
	$result =mysqli_fetch_array( mysqli_query($con,"SELECT SiNo FROM `owner` WHERE SiNo =(SELECT MAX(SiNo) from owner)"));
		mysqli_close($con);

		echo "<script>  window.open('owner_contact.php?itemid=".$result['SiNo']."','_self'); </script>" ;
...
?>
<form action="owner_add.php" method="get">
<table width="200px">
</tr>
<br>
<br>
...
<td>
<input type="text" name="unit" maxlength="50" size="30">
</td>
</tr>
<tr>
<td>
