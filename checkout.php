...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Check Out Asset </h2>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<script type="text/javascript">
	...
	window.open("checkedout2.php?id=".concat(selected),"_self");
...
<button type="button"  onclick="myFunction2()">Check-Out</button>&nbsp;&nbsp;&nbsp;
...
$result = mysqli_query($con,"SELECT * FROM assets where q_checkout>0");


while($row = mysqli_fetch_array($result))
{
echo "<tr>";
echo "<td><input type=\"checkbox\" name=\"check_list[]\" value=\"". $row['ID'] . "\" id=\"". $row['ID'] . "\"></td>";
echo "<td>" . $row['ID'] . "</td>";
echo "<td>" . $row['Item'] . "</td>";
