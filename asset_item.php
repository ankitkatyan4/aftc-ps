...
<link rel="stylesheet" type="text/css" href="table/css/main2.css">
		...
		<h2 class="mb-4">      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Item Wise Report</h2>
...
window.open("asset_item.php?id=".concat(result),"_self");
			...
			<div class="wrap-table100">
				<div class="table100">
					<table>
						...
						<tbody>
						<?php 
						if ( isset($_GET['id'])&& !empty($_GET['id'])){$var = "Where Item LIKE '".$_GET['id']."'";}
						else {$var="";}
$con=mysqli_connect("localhost","root","","aftc_mess");
// Check connection
if (mysqli_connect_errno())
...
$result1 = mysqli_query($con,"SELECT DISTINCT Item FROM assets ".$var);


while($row1 = mysqli_fetch_array($result1))

{
$result = mysqli_query($con,"SELECT * FROM assets Where Item LIKE '".$row1['Item']."'");
echo "<tr style=\"color:black;font-size:12px;\">";
echo " <th colspan=\"7\" > <b>Location : </b> ".$row1['Item'] ." </th>
</tr>";
